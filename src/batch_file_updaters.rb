...
module Dependabot
  ...
  module GithubActions
    class MultiDepFileUpdater < Dependabot::GithubActions::FileUpdater
      def finalize
        self.updated_dependency_files
      end
    end
...
Dependabot::FileUpdaters.register("github_actions", Dependabot::GithubActions::MultiDepFileUpdater)
